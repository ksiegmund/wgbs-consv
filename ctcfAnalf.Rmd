...
ctcflist <- list()
for (i in 1:7){
  wktmp <- import.bw(sprintf("wgEncodeBroadHistone%sCtcfStdSig.bigWig", celllist[[i]]))
...
head(ctcffinal[[22]])
saveRDS(ctcffinal, file = "ctcf_data.Rds")
...
write_csv(ckdata, "ctcf_wgdata.csv")
...
# 7991
write_csv(wkck, "ctcf_wide_unique.csv")
...
write_csv(longdataf, "ctcf_long_unique.csv")
...
ckdata <- bind_rows(comblist)
write_csv(ckdata, "allchrCtcf_data.csv")
