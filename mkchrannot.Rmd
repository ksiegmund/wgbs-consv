...
comparelist <- list(wgdf14pwd, wgdf23pwd, wgdf56pwd, wgdf12pwd, wgdf34pwd, wgdf56npwd)
namelist <- list("N1N2", "JAJB", "IAIB", "DADB", "HAHB", "MAMB")

olddatalist <- list()
for (i in 1:22){
  olddatalist[[i]] <- read.csv(sprintf("Chr%s_data.csv", i), header = TRUE, stringsAsFactors=FALSE) %>% 
...
saveRDS(chrannot, file = "chrannot.Rds")
